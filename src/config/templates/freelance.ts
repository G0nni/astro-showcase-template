...
export const siteConfig: SiteConfig = {
  ...
  seo: {
    ...
    defaultDescription: "Développeur freelance React & Node.js. Je crée des applications web rapides, accessibles et bien conçues.",
  },
  ...
  pages: {
    home: {
      seo: { title: "Accueil", description: "Développeur freelance React & Node.js" },
      sections: [
        {
          type: "hero",
          ...
          props: {
            ...
            subtitle: "Développeur freelance senior avec 7 ans d'expérience. React, Node.js, TypeScript. Disponible pour vos projets.",
        ...
        },
        {
          ...
          props: {
            ...
            columns: 3,
            items: [
              { imageUrl: "https://images.unsplash.com/photo-1547658719-da2b51169166?w=600&auto=format", alt: "Dashboard SaaS", caption: "Dashboard SaaS" },
              { imageUrl: "https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=600&auto=format", alt: "App Analytics", caption: "App Analytics" },
              { imageUrl: "https://images.unsplash.com/photo-1499951360447-b19be8fe80f5?w=600&auto=format", alt: "Site e-commerce", caption: "E-commerce" },
            ],
          },
        },
        {
          ...
          props: {
            ...
            items: [
              { quote: "Alex a livré notre app en 6 semaines, dans le budget. Code impeccable et très bon communicant.", author: "Thomas B.", role: "CTO, Startup Wave" },
              { quote: "Rare de trouver quelqu'un d'aussi à l'écoute et technique. On retravaille avec lui à chaque projet.", author: "Claire M.", role: "Product Manager, Scale Tech" },
            ],
          },
        },
        {
        ...
        },
        {
          ...
          props: {
            ...
            subtitle: "Conseils, outils et retours d'expérience — un email par semaine, pas de spam.",
    ...
    about: {
      seo: { title: "À propos", description: "Mon parcours et mes compétences" },
      sections: [
        {
          type: "text",
          style: { background: "white", padding: "lg" },
        ...
        },
        {
          ...
          props: {
            title: "Parcours",
            items: [
              { date: "2017", title: "Début en freelance", description: "Premier client trouvé via LinkedIn, jamais regardé en arrière." },
              { date: "2019", title: "Spécialisation React", description: "Transition vers le frontend moderne et les architectures SPA." },
              { date: "2021", title: "Full-stack", description: "Ajout de Node.js et PostgreSQL pour des missions plus complètes." },
              { date: "2024", title: "Aujourd'hui", description: "40+ projets, équipes de 2 à 50 personnes, partout en France." },
            ],
          },
        },
        {
      ...
      sections: [
        {
          ...
          props: {
            title: "Parlons-en",
            subtitle: "Je réponds sous 24h. Disponible pour des missions en remote ou Paris.",
